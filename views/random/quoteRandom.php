<div class="inner cover">
    ...
    <blockquote class="text-left">
        <p><?php echo $data['quote']['text']; ?></p>
        <footer><a href="?author_id=<?php echo $data['quote']['author_id']; ?>"><cite title="<?php echo $data['quote']['author']; ?>"><?php echo $data['quote']['author']; ?></cite></a></footer>
    </blockquote>
</p>
<p class="lead">
    <?php
